...
5) Свою работу(сцену на платформе) экспортируйте в виде файла в формате STL(объект B сотрет каждый объект, частично или полностью, который находится внутри пространства объекта  B). В зависимости от того, насколько сложными являются объекты, устройство может занять несколько минут, чтобы выполнить задачу.
...
5) Свою работу(сцену на платформе) экспортируйте в виде файла в формате STL.
